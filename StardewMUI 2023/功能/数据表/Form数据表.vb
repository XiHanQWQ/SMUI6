...
Public Class Form数据表
    ...
    Private Sub UiButton1_Click(sender As Object, e As EventArgs) Handles UiButton1.Click
        ...
        x.获取文本文件数据(GitAPI.GitApiObject.开源代码平台.Gitee, "CYXSJY/SMUI6", "master", "ModsCoordinationDataBase.csv", 设置.全局设置数据("GiteeToken"), False)
    ...
    Private Sub UiButton3_Click(sender As Object, e As EventArgs) Handles UiButton3.Click
        ...
        Else
            ...
            Exit Sub
        End If
        Process.Start("explorer.exe", csvFile)
    End Sub
    ...
    Private Sub LinkLabel1_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel1.LinkClicked
        Process.Start(New ProcessStartInfo("https://afdian.net/order/create?plan_id=049e088e3b5411ef935e5254001e7c00") With {.UseShellExecute = True})
    End Sub
End Class