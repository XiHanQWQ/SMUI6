...
Public Class 设置
    ...
    Public Shared Sub 初始化设置相关操作()
        ...
        AddHandler Form1.UiButton58.Click, Sub(s, e) Process.Start(New ProcessStartInfo("https://www.nexusmods.com/users/myaccount?tab=api") With {.UseShellExecute = True})
        AddHandler Form1.UiButton59.Click, AddressOf 去内置浏览器管理密钥
        AddHandler Form1.UiButton55.Click, AddressOf 让非N网会员去内置浏览器登录
        AddHandler Form1.UiButton56.Click, Sub(s, e) Process.Start(New ProcessStartInfo("https://gitee.com/profile/personal_access_tokens") With {.UseShellExecute = True})
        AddHandler Form1.UiButton57.Click, Sub(s, e) Process.Start(New ProcessStartInfo("https://github.com/settings/tokens") With {.UseShellExecute = True})
        ...
        AddHandler Form1.UiButton72.Click, Sub(s, e) Process.Start(New ProcessStartInfo("https://developer.microsoft.com/zh-cn/microsoft-edge/webview2") With {.UseShellExecute = True})
